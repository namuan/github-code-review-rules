...
class PerformanceTester:
    ...
    async def run_concurrent_test(self, endpoint: str, method: str = 'GET', data: Dict = None, requests_count: int = 100) -> List[TestResult]:
...
async def main():
    ...
    if args.stress:
        ...
        for endpoint_config in endpoints:
            print(f"Testing {endpoint_config['endpoint']}...")
