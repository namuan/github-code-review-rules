...
class TestDataProcessor:
    ...
    def test_add_review_comment_task(self):
    ...
    def test_add_code_snippet_task(self):
    ...
    def test_add_comment_thread_task(self):
    ...
    def test_add_rule_extraction_task(self):
    ...
    def test_add_statistics_update_task(self):
    ...
    def test_validate_review_comment_valid(self):
    ...
    def test_validate_review_comment_invalid(self):
    ...
    def test_validate_code_snippet_invalid(self):
    ...
    def test_validate_comment_thread_valid(self):
    ...
    def test_validate_comment_thread_invalid(self):
    ...
    def test_extract_rule_from_text_imperative(self):
    ...
    def test_extract_rule_from_text_pattern(self):
    ...
    def test_extract_rule_from_text_no_rule(self):
    ...
    def test_extract_rule_from_text_empty(self):
    ...
    def test_categorize_rule_naming(self):
    ...
    def test_categorize_rule_performance(self):
    ...
    def test_categorize_rule_general(self):
    ...
    def test_calculate_confidence_minimal_context(self):
    ...
    def test_get_processing_stats(self):
        ...
        self.processor.add_code_snippet_task({'id': 1, 'content': 'test', 'file_path': 'test.py', 'line_start': 1, 'line_end': 2})
    ...
    def test_process_review_comments_batch(self):
    ...
    def test_process_code_snippets_batch(self):
    ...
    def test_process_comment_threads_batch(self):
