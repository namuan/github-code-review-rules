...
from github_pr_rules_analyzer.models import Repository, PullRequest, ReviewComment, CodeSnippet
...
class TestDataCollector:
    ...
    def test_collect_repository_data_success(self, mock_github_client):
    ...
    @patch('github_pr_rules_analyzer.services.data_collector.GitHubAPIClient')
    def test_collect_repository_data_access_denied(self, mock_github_client):
    ...
    @patch('github_pr_rules_analyzer.services.data_collector.GitHubAPIClient')
    def test_collect_repository_data_pr_collection_error(self, mock_github_client):
    ...
    def test_upsert_repository_new(self):
    ...
    def test_upsert_repository_existing(self):
    ...
    def test_upsert_pull_request_new(self):
        ...
        with patch('github_pr_rules_analyzer.services.data_collector.PullRequest') as mock_pr_class:
            ...
            result = self.collector._upsert_pull_request(mock_pr_data, repository_id)
    ...
    def test_upsert_pull_request_existing(self):
    ...
    def test_upsert_review_comment_new(self):
        ...
        with patch('github_pr_rules_analyzer.services.data_collector.ReviewComment') as mock_comment_class:
            ...
            result = self.collector._upsert_review_comment(mock_comment_data, pull_request_id)
...
+    return True
 def another_function():
    ...
    def test_create_comment_thread_new(self):
    ...
    def test_create_comment_thread_existing(self):
    ...
    def test_get_collection_status(self):
        ...
        # Mock query results
        mock_session.query.return_value.count.side_effect = [5, 10, 25, 50, 15]  # repos, prs, comments, snippets, threads
    ...
    def test_cleanup_old_data(self):
        ...
        # Mock query results
        mock_session.query.return_value.filter.return_value.delete.side_effect = [10, 5, 2, 1, 0]  # snippets, threads, comments, prs, repos
