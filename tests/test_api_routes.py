...
from github_pr_rules_analyzer.utils.database import get_session_local, Base
...
class TestAPIRoutes:
    ...
    def test_get_rule_severities(self):
    ...
    def test_get_repository_rules_not_found(self):
    ...
    def test_get_repository_statistics_not_found(self):
    ...
    def test_extract_rules_no_comments(self):
    ...
    def test_extract_rules_invalid_input(self):
