...
class TestIntegration:
    ...
    def test_full_workflow_repository_addition_to_rule_extraction(self):
    ...
    def test_repository_rules_filtering(self):
    ...
    def test_repository_statistics_endpoint(self):
    ...
    def test_api_rate_limiting_and_error_responses(self):
