...
class RuleStatistics(Base):
    ...
    # Indexes
    __table_args__ = (
        Index('idx_rule_statistics_dates', 'first_seen', 'last_seen'),
    )
    ...
    def increment_occurrence(self, confidence_score=None):
    ...
    def update_first_seen(self, timestamp):
    ...
    def get_recency_description(self):
    ...
    def get_impact_score(self):
        ...
        impact_score = (normalized_confidence * confidence_weight + 
    ...
    def get_priority_level(self):
        ...
        if impact_score >= 0.8 and trend in ["frequent", "moderate"]:
            return "high"
        elif impact_score >= 0.6 or trend == "frequent":
            return "medium"
