...
class ReviewComment(Base):
    ...
    # Indexes
    __table_args__ = (
        Index('idx_review_comments_dates', 'created_at'),
    )
    ...
    @classmethod
    def from_github_data(cls, github_data, pull_request_id):
        ...
        return cls(
            ...
            updated_at=datetime.fromisoformat(github_data["updated_at"].replace("Z", "+00:00")) if github_data.get("updated_at") else None,
    ...
    def update_from_github_data(self, github_data):
        ...
        self.updated_at = datetime.fromisoformat(github_data["updated_at"].replace("Z", "+00:00")) if github_data.get("updated_at") else None
